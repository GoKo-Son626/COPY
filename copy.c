 ...
 * @FilePath: \undefinedc:\Users\49551\Desktop\copy.c
 * @Description: 
*/
...
static void LE *GPIOI_OSPEEDR_PI;
...
void int led_open(struct inode *inode, struct file *filp) {
        filp->private_data = &newchrled; /* 设置私有数据 */
	return 0;
};

void ssize_t led_rend(struct file *filp, char __user *buf, size_t cnt, loff_t *offt) {
        return 0;
}

void led_write(struct file *filp, const char *buf, size_t cnt, loff_t *offt) {
        int retvalue;
...
void led_release(struct inode *inode, struct file *filp) {
        return 0;
}
